...
export DISPLAY=:1
export HOME=/tmp/assistant-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${ASSISTANT_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${ASSISTANT_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${ASSISTANT_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${ASSISTANT_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${ASSISTANT_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${ASSISTANT_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${ASSISTANT_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${ASSISTANT_BROWSER_NOVNC_PASSWORD:-}"

DISABLE_GRAPHICS_FLAGS="${ASSISTANT_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${ASSISTANT_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${ASSISTANT_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
AUTO_START_TIMEOUT_MS="${ASSISTANT_BROWSER_AUTO_START_TIMEOUT_MS:-12000}"
...
if [[ -z "${CDP_SOURCE_RANGE}" ]]; then
  ...
  echo "[sandbox-browser] Set ASSISTANT_BROWSER_CDP_SOURCE_RANGE to an explicit CIDR to enable CDP access." >&2
else
