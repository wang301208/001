...
if [[ -z "$version_content" ]]; then
  echo "<h2>Assistant $VERSION</h2>"
  echo "<p>Latest Assistant update.</p>"
  echo "<p><a href=\"https://github.com/assistant/assistant/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
