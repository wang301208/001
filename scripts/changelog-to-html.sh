...
if [[ -z "$version_content" ]]; then
  echo "<h2>Zhushou $VERSION</h2>"
  echo "<p>Latest Zhushou update.</p>"
  echo "<p><a href=\"https://github.com/wang301208/zhushou/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
