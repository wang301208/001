...
export function readRunnerOverrideEnv(env = process.env) {
  ...
  return {
    varUbuntuRunner: preferNonEmptyEnv(
      ...
      env.ZHUSHOU_RELEASE_CHECKS_UBUNTU_RUNNER ?? env.zhushou_RELEASE_CHECKS_UBUNTU_RUNNER,
    ),
    varWindowsRunner: preferNonEmptyEnv(
      env.VAR_WINDOWS_RUNNER,
      env.ZHUSHOU_RELEASE_CHECKS_WINDOWS_RUNNER ?? env.zhushou_RELEASE_CHECKS_WINDOWS_RUNNER,
    ),
    varMacosRunner: preferNonEmptyEnv(
      env.VAR_MACOS_RUNNER,
      env.ZHUSHOU_RELEASE_CHECKS_MACOS_RUNNER ?? env.zhushou_RELEASE_CHECKS_MACOS_RUNNER,
    ),
  };
}
