...
const REPLACEMENTS = [
  ...
  // GitHub 仓库引用
  { pattern: /github\.com\/zhushou\/zhushou/g, replacement: "github.com/wang301208/zhushou" },
  ...
  { pattern: /\bZhushou\b(?! Gateway)/g, replacement: "助手" },
  { pattern: /\bzhushou\b(?! gateway)/gi, replacement: "zhushou" },
];
