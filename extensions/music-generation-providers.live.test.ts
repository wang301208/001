...
const providerFilter = parseCsvFilter(process.env.ZHUSHOU_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.ZHUSHOU_LIVE_MUSIC_GENERATION_MODELS);
