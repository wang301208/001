...
const providerFilter = parseCsvFilter(process.env.ASSISTANT_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.ASSISTANT_LIVE_MUSIC_GENERATION_MODELS);
