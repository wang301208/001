import { DEFAULT_ACCOUNT_ID, type AssistantConfig } from "assistant/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "assistant/plugin-sdk/webhook-ingress";
