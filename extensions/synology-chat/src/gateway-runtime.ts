import { DEFAULT_ACCOUNT_ID, type ZhushouConfig } from "zhushou/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "zhushou/plugin-sdk/webhook-ingress";
