...
import { resolveDangerousNameMatchingEnabled } from "assistant/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full 助手 config object. */
function getChannelConfig(cfg: AssistantConfig): SynologyChatChannelConfig | undefined {
...
export function resolveAccount(
  ...
  const envBotName = process.env.ASSISTANT_BOT_NAME ?? "助手";
