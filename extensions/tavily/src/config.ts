...
export function resolveTavilySearchConfig(cfg?: AssistantConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: AssistantConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: AssistantConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
