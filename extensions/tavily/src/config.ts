...
export function resolveTavilySearchConfig(cfg?: ZhushouConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: ZhushouConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: ZhushouConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
