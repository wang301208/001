import type { DirectoryConfigParams } from "assistant/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "assistant/plugin-sdk/messaging-targets";
