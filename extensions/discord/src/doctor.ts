...
import { collectProviderDangerousNameMatchingScopes } from "assistant/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: AssistantConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: AssistantConfig,
  doctorFixCommand: string,
): { config: AssistantConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: AssistantConfig): string[] {
