...
import type { DiscordAccountConfig, DiscordActionConfig, ZhushouConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: ZhushouConfig): ResolvedDiscordAccount[] {
