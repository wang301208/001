...
import type { DiscordAccountConfig, DiscordActionConfig, AssistantConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: AssistantConfig): ResolvedDiscordAccount[] {
