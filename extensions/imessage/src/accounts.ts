...
function mergeIMessageAccountConfig(cfg: AssistantConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AssistantConfig): ResolvedIMessageAccount[] {
