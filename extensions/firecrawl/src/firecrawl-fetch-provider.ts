import type { WebFetchProviderPlugin } from "assistant/plugin-sdk/provider-web-fetch";
import { enablePluginInConfig } from "assistant/plugin-sdk/provider-web-fetch";
