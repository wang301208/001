...
} from "assistant/plugin-sdk/provider-setup";
import type { WizardPrompter } from "assistant/plugin-sdk/setup";
...
vi.mock("assistant/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("assistant/plugin-sdk/provider-auth")>();
  return {
    ...actual,
...
vi.mock("assistant/plugin-sdk/provider-setup", async (importOriginal) => {
  const actual = await importOriginal<typeof import("assistant/plugin-sdk/provider-setup")>();
  return {
    ...actual,
...
function buildConfig(): AssistantConfig {
  return {
    models: {
      providers: {
        lmstudio: {
