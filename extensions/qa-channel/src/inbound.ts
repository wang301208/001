...
import { dispatchInboundReplyWithBase } from "assistant/plugin-sdk/inbound-reply-dispatch";
import {
...
export async function handleQaInbound(params: {
  ...
  const body = runtime.channel.reply.formatAgentEnvelope({
    ...
    previousTimestamp,
    envelope: runtime.channel.reply.resolveEnvelopeFormatOptions(params.config as AssistantConfig),
    body: inbound.text,
  });
