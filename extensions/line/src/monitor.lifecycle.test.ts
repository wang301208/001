...
import { WEBHOOK_IN_FLIGHT_DEFAULTS } from "assistant/plugin-sdk/webhook-request-guards";
...
vi.mock("assistant/plugin-sdk/reply-runtime", () => ({
...
vi.mock("assistant/plugin-sdk/webhook-ingress", () => ({
