import type { ChannelSetupAdapter, ZhushouConfig } from "zhushou/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "zhushou/plugin-sdk/setup";
...
export function isLineConfigured(cfg: ZhushouConfig, accountId: string): boolean {
