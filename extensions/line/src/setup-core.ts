import type { ChannelSetupAdapter, AssistantConfig } from "assistant/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "assistant/plugin-sdk/setup";
...
export function isLineConfigured(cfg: AssistantConfig, accountId: string): boolean {
