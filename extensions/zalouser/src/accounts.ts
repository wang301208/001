...
function mergeZalouserAccountConfig(cfg: AssistantConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: AssistantConfig; accountId?: string | null }) {
