...
function mergeZalouserAccountConfig(cfg: ZhushouConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: ZhushouConfig; accountId?: string | null }) {
