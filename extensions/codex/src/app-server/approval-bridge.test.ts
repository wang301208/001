import { callGatewayTool, type EmbeddedRunAttemptParams } from "assistant/plugin-sdk/agent-harness";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { buildApprovalResponse, handleCodexAppServerApprovalRequest } from "./approval-bridge.js";

vi.mock("assistant/plugin-sdk/agent-harness", async (importOriginal) => ({
  ...(await importOriginal<typeof import("assistant/plugin-sdk/agent-harness")>()),
