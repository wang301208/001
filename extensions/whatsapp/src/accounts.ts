...
export function listWhatsAppAuthDirs(cfg: ZhushouConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ZhushouConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: ZhushouConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ZhushouConfig): ResolvedWhatsAppAccount[] {
