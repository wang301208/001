...
import { resolveOAuthDir } from "assistant/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: AssistantConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AssistantConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AssistantConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AssistantConfig): ResolvedWhatsAppAccount[] {
