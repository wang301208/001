export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "zhushou/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "zhushou/plugin-sdk/reply-runtime";
