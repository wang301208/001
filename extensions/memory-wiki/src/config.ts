...
import { buildPluginConfigSchema, z, type ZhushouPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: ZhushouPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".zhushou", "wiki", "main");
}
