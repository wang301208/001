...
import { isVoiceCompatibleAudio } from "assistant/plugin-sdk/media-runtime";
import {
  captureHttpExchange,
...
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "assistant/plugin-sdk/speech";
