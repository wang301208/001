...
describe("loginGeminiCliOAuth", () => {
  ...
  const ENV_KEYS = [
    "ZHUSHOU_GEMINI_OAUTH_CLIENT_ID",
    "ZHUSHOU_GEMINI_OAUTH_CLIENT_SECRET",
  ...
  beforeEach(() => {
    envSnapshot = Object.fromEntries(ENV_KEYS.map((key) => [key, process.env[key]]));
    process.env.ZHUSHOU_GEMINI_OAUTH_CLIENT_ID = "test-client-id.apps.googleusercontent.com";
    process.env.ZHUSHOU_GEMINI_OAUTH_CLIENT_SECRET = "GOCSPX-test-client-secret"; // pragma: allowlist secret
