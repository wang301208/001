...
import type { ChannelMessageActionAdapter } from "assistant/plugin-sdk/channel-contract";
import { clearAccountEntryFields, createChatChannelPlugin } from "assistant/plugin-sdk/channel-core";
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as AssistantConfig;
