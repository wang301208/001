...
let clearRuntimeConfigSnapshot: typeof import("zhushou/plugin-sdk/config-runtime").clearRuntimeConfigSnapshot;
let setRuntimeConfigSnapshot: typeof import("zhushou/plugin-sdk/config-runtime").setRuntimeConfigSnapshot;
