...
import { isDiagnosticsEnabled } from "assistant/plugin-sdk/diagnostic-runtime";
import type { RuntimeEnv } from "assistant/plugin-sdk/runtime-env";
import { defaultRuntime } from "assistant/plugin-sdk/runtime-env";
...
import { readJsonBodyWithLimit } from "assistant/plugin-sdk/webhook-request-guards";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: AssistantConfig): string {
