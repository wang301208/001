...
import { getRuntimeConfigSnapshot } from "assistant/plugin-sdk/config-runtime";
import { jsonResult, readStringParam } from "assistant/plugin-sdk/provider-web-search";
import {
    ...
    execute: async (_toolCallId: string, args: Record<string, unknown>) => {
      ...
      if (!apiKey) {
        return jsonResult({
          ...
          docs: "https://docs.assistant.ai/tools/code-execution",
        });
      }
