...
export function resolveLegacyXSearchConfig(config?: ZhushouConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: ZhushouConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: ZhushouConfig): JsonRecord | undefined {
