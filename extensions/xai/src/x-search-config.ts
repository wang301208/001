...
export function resolveLegacyXSearchConfig(config?: AssistantConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: AssistantConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: AssistantConfig): JsonRecord | undefined {
