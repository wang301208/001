...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<AssistantConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<AssistantConfig["channels"]>["slack"]>>,
): AssistantConfig {
  return {
    channels: {
      slack: {
