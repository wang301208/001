import { resolveGlobalDedupeCache } from "assistant/plugin-sdk/infra-runtime";
 ...
 */
const SLACK_THREAD_PARTICIPATION_KEY = Symbol.for("assistant.slackThreadParticipation");
