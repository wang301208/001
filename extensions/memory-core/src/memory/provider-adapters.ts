...
import { resolveUserPath } from "zhushou/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "zhushou/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall 助手 (this should install node-llama-cpp): npm i -g zhushou@latest"
      : null,
