...
import { resolveUserPath } from "assistant/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "assistant/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall 助手 (this should install node-llama-cpp): npm i -g assistant@latest"
      : null,
