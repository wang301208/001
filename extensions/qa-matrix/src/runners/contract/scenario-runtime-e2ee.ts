...
import type { MatrixVerificationSummary } from "@zhushou/matrix/test-api.js";
...
export async function runMatrixQaE2eeArtifactRedactionScenario(
  ...
  return {
    ...
    details: [
      ...
      "observed-event artifacts redact body/formatted_body unless ZHUSHOU_QA_MATRIX_CAPTURE_CONTENT=1",
      `encrypted room id: ${result.roomId}`,
      ...buildMatrixReplyDetails("E2EE reply", result.reply),
    ].join("\n"),
  };
