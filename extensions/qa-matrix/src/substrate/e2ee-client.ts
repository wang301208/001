...
import type {
  ...
  MessageEventContent,
} from "@assistant/matrix/test-api.js";
...
type MatrixQaE2eeRuntime = typeof import("@assistant/matrix/test-api.js");
...
async function loadMatrixQaE2eeRuntime(): Promise<MatrixQaE2eeRuntime> {
  const { loadQaRunnerBundledPluginTestApi } =
    await import("assistant/plugin-sdk/qa-runner-runtime");
