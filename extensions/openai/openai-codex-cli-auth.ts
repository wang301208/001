...
import type { AuthProfileStore, OAuthCredential } from "assistant/plugin-sdk/provider-auth";
import { resolveRequiredHomeDir } from "assistant/plugin-sdk/provider-auth";
