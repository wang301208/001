...
import type { DiagnosticEventPayload, ZhushouPluginService } from "../api.js";
...
export function createDiagnosticsOtelService(): ZhushouPluginService {
  ...
  } satisfies ZhushouPluginService;
}
