...
const WORKER_RUNTIME_STATE = Symbol.for("assistant.testSetupRuntimeState");
const WORKER_RUNTIME_HELPERS = Symbol.for("assistant.testSetupRuntimeHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: AssistantConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
