...
function resolveSignalMaxBytes(cfg: ZhushouConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: ZhushouConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
