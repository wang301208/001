...
function resolveSignalMaxBytes(cfg: AssistantConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: AssistantConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
