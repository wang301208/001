...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ZhushouConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ZhushouConfig; env: NodeJS.ProcessEnv }): {
  cfg: ZhushouConfig;
  changes: string[];
} {
