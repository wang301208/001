...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AssistantConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AssistantConfig; env: NodeJS.ProcessEnv }): {
  cfg: AssistantConfig;
  changes: string[];
} {
