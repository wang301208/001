...
export function resolveMemoryDreamingPluginId(
  cfg: ZhushouConfig | Record<string, unknown> | undefined,
): string {
...
export function resolveMemoryDreamingWorkspaces(cfg: ZhushouConfig): MemoryDreamingWorkspace[] {
