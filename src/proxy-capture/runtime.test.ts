...
describe("debug proxy runtime", () => {
  const envKeys = [
    ...
    "ZHUSHOU_DEBUG_PROXY_SOURCE_PROCESS",
  ] as const;
  ...
  beforeEach(() => {
    ...
    process.env.ZHUSHOU_DEBUG_PROXY_SESSION_ID = "runtime-test-session";
    process.env.ZHUSHOU_DEBUG_PROXY_SOURCE_PROCESS = "runtime-test";
  });
