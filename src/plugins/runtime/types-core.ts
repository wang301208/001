...
import type { PluginRuntimeAutonomy } from "./runtime-autonomy.types.js";
...
export type PluginRuntimeCore = {
  version: string;
  config: {
    loadConfig: () => import("../../config/types.assistant.js").AssistantConfig;
    writeConfigFile: (
      cfg: import("../../config/types.assistant.js").AssistantConfig,
  ...
  autonomy: PluginRuntimeAutonomy;
  tasks: {
