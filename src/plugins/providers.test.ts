...
type LoadZhushouPlugins = typeof import("./loader.js").loadZhushouPlugins;
...
const loadZhushouPluginsMock = vi.fn<LoadZhushouPlugins>();
...
function getLastSetupLoadedPluginConfig() {
  const call = loadZhushouPluginsMock.mock.calls.at(-1)?.[0];
  expect(call).toBeDefined();
...
describe("resolvePluginProviders", () => {
  beforeAll(async () => {
    ...
    vi.doMock("./loader.js", () => ({
      loadZhushouPlugins: (...args: Parameters<LoadZhushouPlugins>) =>
        loadZhushouPluginsMock(...args),
  ...
  beforeEach(() => {
    ...
    loadZhushouPluginsMock.mockReturnValue(registry);
