...
import { normalizeZhushouVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeZhushouVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeZhushouVersionBase(plugin.version) ??
    plugin.version
  );
}
