...
import type { SessionTaskContinuation } from "../../task-status-override.js";
...
> {
  const isContinuationTurn =
    ...
    (await params.hasCompletedBootstrapTurn(params.sessionFile, params.checkpointContinuation));
