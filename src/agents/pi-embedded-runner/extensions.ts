...
function resolveCompactionMode(cfg?: AssistantConfig): "default" | "safeguard" {
...
export function buildEmbeddedExtensionFactories(params: {
  ...
  /** Preferred consumer-specific override for safeguard compaction summarization. */
  projectedTaskStatusOverride?: string;
  /** Legacy compatibility alias for projectedTaskStatusOverride. */
  taskStatusOverride?: string;
  projectedTaskStatusAudit?: import("../task-status-override.js").ContinuationAuditPayload;
  projectedTaskStatusExplanation?: import("../task-status-override.js").ContinuationDecisionExplanation;
}): ExtensionFactory[] {
  ...
  if (resolveCompactionMode(params.cfg) === "safeguard") {
    ...
    setCompactionSafeguardRuntime(params.sessionManager, {
      ...
      taskContinuityHint: params.taskContinuityHint,
      ...
      projectedTaskStatusAudit: params.projectedTaskStatusAudit,
      projectedTaskStatusExplanation:
        params.projectedTaskStatusExplanation ?? params.projectedTaskStatusAudit?.explanation,
