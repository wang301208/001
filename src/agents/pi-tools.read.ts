...
function resolveAdaptiveReadMaxBytes(options?: ZhushouReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createZhushouReadTool(base, {
...
export function createZhushouReadTool(
  base: AnyAgentTool,
  options?: ZhushouReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
