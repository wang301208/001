...
function resolveAdaptiveReadMaxBytes(options?: AssistantReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAssistantReadTool(base, {
...
export function createAssistantReadTool(
  base: AnyAgentTool,
  options?: AssistantReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
