...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.assistant/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "assistant doctor" and "assistant approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
