...
import { resolveAssistantPluginToolInputs } from "./assistant-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("assistant plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveAssistantPluginToolInputs({
      options: {
        config: {} as never,
