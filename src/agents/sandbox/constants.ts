...
export const DEFAULT_SANDBOX_IMAGE = "assistant-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "assistant-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "assistant-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "assistant-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "assistant-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "assistant-sandbox-browser";
