...
export const DEFAULT_SANDBOX_IMAGE = "zhushou-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "zhushou-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "zhushou-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "zhushou-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "zhushou-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "zhushou-sandbox-browser";
