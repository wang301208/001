...
export type CreateAssistantToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateAssistantToolsOpts) {
...
vi.mock("../config/sessions.js", async () => {
  ...
  return {
    ...
    resolveStorePath: () => "/tmp/assistant-sessions-spawn-test-store.json",
