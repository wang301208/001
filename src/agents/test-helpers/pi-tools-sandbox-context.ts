...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "assistant-sbx-test",
    runtimeLabel: params.containerName ?? "assistant-sbx-test",
    containerName: params.containerName ?? "assistant-sbx-test",
