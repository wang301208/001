...
async function resolveContext(config: AssistantConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): AssistantConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
