export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_ZHUSHOU_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_ZHUSHOU_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[ZHUSHOU_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[ZHUSHOU_INTERNAL_CONTEXT_END]]";
