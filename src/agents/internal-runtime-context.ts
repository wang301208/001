export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_ASSISTANT_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_ASSISTANT_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[ASSISTANT_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[ASSISTANT_INTERNAL_CONTEXT_END]]";
