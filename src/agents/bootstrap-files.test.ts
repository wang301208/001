...
describe("resolveBootstrapFilesForRun", () => {
  ...
  it("applies bootstrap hook overrides", async () => {
    ...
    const workspaceDir = await makeTempWorkspace("assistant-bootstrap-");
...
describe("hasCompletedBootstrapTurn", () => {
  ...
  beforeEach(async () => {
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "assistant-bootstrap-turn-"));
  });
  ...
  it("returns false when meaningful continuity compaction happened after the last assistant turn", async () => {
