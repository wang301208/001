...
export function isConfigPathTruthy(config: ZhushouConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["zhushou-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: ZhushouConfig): string[] | undefined {
