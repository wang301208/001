...
export function isConfigPathTruthy(config: AssistantConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["assistant-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: AssistantConfig): string[] | undefined {
