...
describe("createAssistantCodingTools", () => {
  const testConfig: AssistantConfig = {};

  it("preserves action enums in normalized schemas", () => {
    const defaultTools = createAssistantCodingTools({ config: testConfig, senderIsOwner: true });
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const openAiTools = createAssistantCodingTools({
      config: testConfig,
    ...
    const codexTools = createAssistantCodingTools({
      config: testConfig,
    ...
    const disabledOpenAiTools = createAssistantCodingTools({
    ...
    const anthropicTools = createAssistantCodingTools({
      config: disabledConfig,
    ...
    const allowModelsConfig: AssistantConfig = {
      tools: {
        exec: {
    ...
    const allowed = createAssistantCodingTools({
    ...
    const denied = createAssistantCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
    ...
    const oauthTools = createAssistantCodingTools({
      config: testConfig,
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
  ...
  it("provides top-level object schemas for all tools", () => {
    const tools = createAssistantCodingTools({ config: testConfig });
