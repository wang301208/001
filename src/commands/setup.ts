...
type SetupCommandDeps = {
  ...
  writeConfigFile?: (config: ZhushouConfig) => Promise<void>;
};
...
async function writeDefaultConfigFile(config: ZhushouConfig): Promise<void> {
