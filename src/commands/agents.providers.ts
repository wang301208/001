...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AssistantConfig): boolean {
...
export function summarizeBindings(cfg: AssistantConfig, bindings: AgentBinding[]): string[] {
