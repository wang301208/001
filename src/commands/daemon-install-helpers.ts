...
const MANAGED_SERVICE_ENV_KEYS_VAR = "ZHUSHOU_SERVICE_MANAGED_ENV_KEYS";
...
export function gatewayInstallErrorHint(platform = process.platform): string {
  return platform === "win32"
    ...
    : `Tip: rerun \`${formatCliCommand("zhushou gateway install")}\` after fixing the error.`;
}
