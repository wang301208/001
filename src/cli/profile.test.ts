...
describe("formatCliCommand", () => {
  ...
  it("trims whitespace from profile", () => {
    expect(formatCliCommand("zhushou doctor --fix", { ZHUSHOU_PROFILE: "  jbzhushou  " })).toBe(
      "zhushou --profile jbzhushou doctor --fix",
    );
  });
  ...
  it("inserts --container when a container hint is set", () => {
    expect(
      formatCliCommand("zhushou gateway status --deep", { ZHUSHOU_CONTAINER_HINT: "demo" }),
  ...
  it("ignores unsafe container hints", () => {
    expect(
      formatCliCommand("zhushou gateway status --deep", {
        ZHUSHOU_CONTAINER_HINT: "demo; rm -rf /",
      }),
    ).toBe("zhushou gateway status --deep");
  });
  ...
  it("does not prepend --container for update commands", () => {
    expect(formatCliCommand("zhushou update", { ZHUSHOU_CONTAINER_HINT: "demo" })).toBe(
      "zhushou update",
    );
    expect(
      formatCliCommand("pnpm zhushou update --channel beta", { ZHUSHOU_CONTAINER_HINT: "demo" }),
