...
function resolveAcpStreamCoalesceIdleMs(cfg: AssistantConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: AssistantConfig): number {
...
export function resolveAcpProjectionSettings(cfg: AssistantConfig): AcpProjectionSettings {
