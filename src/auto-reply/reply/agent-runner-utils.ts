...
import { getRuntimeConfigSnapshot, type AssistantConfig } from "../../config/config.js";
import {
...
export function resolveQueuedReplyRuntimeConfig(config: AssistantConfig): AssistantConfig {
  return (
