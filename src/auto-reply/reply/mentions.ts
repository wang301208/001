...
function resolveMentionPatterns(cfg: AssistantConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AssistantConfig | undefined, agentId?: string): RegExp[] {
