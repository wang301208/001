...
function resolveMentionPatterns(cfg: ZhushouConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ZhushouConfig | undefined, agentId?: string): RegExp[] {
