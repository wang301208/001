...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "assistant.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by the assistant out-of-band. Treat it as authoritative metadata about the current message context.",
