...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "assistant-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "assistant-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "assistant-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "assistant-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "assistant-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "assistant-legacy-state");
    const configDir = path.join("/tmp", "assistant-current-config");
