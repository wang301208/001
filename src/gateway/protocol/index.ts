...
import {
  ...
  type GovernanceCapabilityInventorySummary,
  GovernanceCapabilityInventorySummarySchema,
  type GovernanceGenesisPlanParams,
  ...
  type GovernanceProposalApplyRecord,
  GovernanceProposalApplyRecordSchema,
  type GovernanceProposalsReconcileParams,
  GovernanceProposalsReconcileParamsSchema,
  type GovernanceProposalsReconcileResult,
  GovernanceProposalsReconcileResultSchema,
  type GovernanceProposalsApplyParams,
  GovernanceProposalsApplyParamsSchema,
  type GovernanceProposalsApplyManyParams,
  GovernanceProposalsApplyManyParamsSchema,
  type GovernanceProposalsApplyResult,
  GovernanceProposalsApplyResultSchema,
  type GovernanceProposalsRevertParams,
  GovernanceProposalsRevertParamsSchema,
  type GovernanceProposalsRevertManyParams,
  GovernanceProposalsRevertManyParamsSchema,
  type GovernanceProposalsRevertResult,
...
export const validateAgentEvent = ajv.compile<AgentEvent>(AgentEventSchema);
export const validateAutonomyListParams = ajv.compile<AutonomyListParams>(AutonomyListParamsSchema);
export const validateAutonomyOverviewParams = ajv.compile<AutonomyOverviewParams>(
  AutonomyOverviewParamsSchema,
);
export const validateAutonomyCapabilityInventoryParams =
  ajv.compile<AutonomyCapabilityInventoryParams>(AutonomyCapabilityInventoryParamsSchema);
export const validateAutonomyGenesisPlanParams =
  ajv.compile<AutonomyGenesisPlanParams>(AutonomyGenesisPlanParamsSchema);
export const validateAutonomyHealParams = ajv.compile<AutonomyHealParams>(AutonomyHealParamsSchema);
export const validateAutonomySuperviseParams =
  ajv.compile<AutonomySuperviseParams>(AutonomySuperviseParamsSchema);
export const validateAutonomyActivateParams =
  ajv.compile<AutonomyActivateParams>(AutonomyActivateParamsSchema);
export const validateAutonomyHistoryParams =
  ajv.compile<AutonomyHistoryParams>(AutonomyHistoryParamsSchema);
export const validateAutonomyGovernanceProposalsParams =
  ajv.compile<AutonomyGovernanceProposalsParams>(AutonomyGovernanceProposalsParamsSchema);
export const validateAutonomyGovernanceReconcileParams =
  ajv.compile<AutonomyGovernanceReconcileParams>(AutonomyGovernanceReconcileParamsSchema);
export const validateAutonomyShowParams = ajv.compile<AutonomyShowParams>(AutonomyShowParamsSchema);
export const validateAutonomyStartParams =
  ajv.compile<AutonomyStartParams>(AutonomyStartParamsSchema);
export const validateAutonomySubmitSandboxReplayParams =
  ajv.compile<AutonomySubmitSandboxReplayParams>(AutonomySubmitSandboxReplayParamsSchema);
export const validateAutonomyCancelParams =
  ajv.compile<AutonomyCancelParams>(AutonomyCancelParamsSchema);
export const validateAutonomyLoopShowParams =
  ajv.compile<AutonomyLoopShowParams>(AutonomyLoopShowParamsSchema);
export const validateAutonomyLoopUpsertParams =
  ajv.compile<AutonomyLoopUpsertParams>(AutonomyLoopUpsertParamsSchema);
export const validateAutonomyLoopReconcileParams =
  ajv.compile<AutonomyLoopReconcileParams>(AutonomyLoopReconcileParamsSchema);
export const validateAutonomyLoopRemoveParams =
  ajv.compile<AutonomyLoopRemoveParams>(AutonomyLoopRemoveParamsSchema);
export const validateGovernanceOverviewParams =
  ajv.compile<GovernanceOverviewParams>(GovernanceOverviewParamsSchema);
export const validateGovernanceAgentParams =
  ajv.compile<GovernanceAgentParams>(GovernanceAgentParamsSchema);
export const validateGovernanceTeamParams =
  ajv.compile<GovernanceTeamParams>(GovernanceTeamParamsSchema);
export const validateGovernanceCapabilityInventoryParams =
  ajv.compile<GovernanceCapabilityInventoryParams>(GovernanceCapabilityInventoryParamsSchema);
export const validateGovernanceCapabilityAssetRegistryParams =
  ajv.compile<GovernanceCapabilityAssetRegistryParams>(
    GovernanceCapabilityAssetRegistryParamsSchema,
  );
export const validateGovernanceGenesisPlanParams =
  ajv.compile<GovernanceGenesisPlanParams>(GovernanceGenesisPlanParamsSchema);
export const validateGovernanceProposalsListParams =
  ajv.compile<GovernanceProposalsListParams>(GovernanceProposalsListParamsSchema);
export const validateGovernanceProposalsSynthesizeParams =
  ajv.compile<GovernanceProposalsSynthesizeParams>(GovernanceProposalsSynthesizeParamsSchema);
export const validateGovernanceProposalsReconcileParams =
  ajv.compile<GovernanceProposalsReconcileParams>(GovernanceProposalsReconcileParamsSchema);
export const validateGovernanceProposalsCreateParams =
  ajv.compile<GovernanceProposalsCreateParams>(GovernanceProposalsCreateParamsSchema);
export const validateGovernanceProposalsReviewParams =
  ajv.compile<GovernanceProposalsReviewParams>(GovernanceProposalsReviewParamsSchema);
export const validateGovernanceProposalsReviewManyParams =
  ajv.compile<GovernanceProposalsReviewManyParams>(GovernanceProposalsReviewManyParamsSchema);
export const validateGovernanceProposalsApplyParams =
  ajv.compile<GovernanceProposalsApplyParams>(GovernanceProposalsApplyParamsSchema);
export const validateGovernanceProposalsApplyManyParams =
  ajv.compile<GovernanceProposalsApplyManyParams>(GovernanceProposalsApplyManyParamsSchema);
export const validateGovernanceProposalsRevertParams =
  ajv.compile<GovernanceProposalsRevertParams>(GovernanceProposalsRevertParamsSchema);
export const validateGovernanceProposalsRevertManyParams =
  ajv.compile<GovernanceProposalsRevertManyParams>(GovernanceProposalsRevertManyParamsSchema);
...
export const validateChannelsConnectParams = ajv.compile<ChannelsConnectParams>(
  ChannelsConnectParamsSchema,
);
...
export type {
  ...
  AutonomyListParams,
  AutonomyOverviewParams,
  AutonomyCapabilityInventoryEntryActivation,
  AutonomyCapabilityInventoryEntry,
  AutonomyCapabilityGap,
  AutonomyCapabilityInventorySummary,
  AutonomyCapabilityInventoryParams,
  AutonomyCapabilityInventoryResult,
  AutonomyGenesisPlanStage,
  AutonomyGenesisPlanParams,
  AutonomyGenesisPlanResult,
  AutonomyHealParams,
  AutonomyActivateParams,
  AutonomyHistoryParams,
  AutonomyGovernanceProposalItem,
  ...
  GovernanceCapabilityInventoryParams,
  GovernanceCapabilityInventoryResult,
  GovernanceGenesisPlanStage,
  GovernanceGenesisPlanParams,
  GovernanceGenesisPlanResult,
  GovernanceProposalOperation,
  GovernanceProposalReviewRecord,
  GovernanceProposalApplyRecord,
  GovernanceProposalRecord,
  GovernanceProposalSummary,
  GovernanceProposalLedger,
  GovernanceProposalsReconcileParams,
  GovernanceProposalsReconcileResult,
  GovernanceOverviewParams,
  GovernanceOverviewResult,
  GovernanceAgentParams,
  GovernanceAgentResult,
  GovernanceProposalsSynthesizeParams,
  GovernanceProposalsSynthesizeResult,
  GovernanceProposalsListParams,
  GovernanceProposalsListResult,
  GovernanceProposalsCreateParams,
  GovernanceProposalsCreateResult,
  GovernanceProposalsReviewParams,
  GovernanceProposalsReviewResult,
  GovernanceProposalsApplyParams,
  GovernanceProposalsApplyResult,
  GovernanceProposalsRevertParams,
