                ...
                units: Type.Array(Type.Object(
                  {
                    ...
                    lastStartedAt: Type.Optional(Type.Integer({ minimum: 0 })),
                    lastFinishedAt: Type.Optional(Type.Integer({ minimum: 0 })),
                    lastOk: Type.Optional(Type.Boolean()),
                    lastError: Type.Optional(Type.String()),
                    lastChangedCount: Type.Optional(Type.Integer({ minimum: 0 })),
                    lastDetail: Type.Optional(Type.String()),
                    intervalMs: Type.Optional(Type.Integer({ minimum: 1 })),
                    nextRunAt: Type.Optional(Type.Integer({ minimum: 0 })),
                    lastSteps: Type.Optional(Type.Array(Type.Object(
                      {
                        name: NonEmptyString,
                        ok: Type.Boolean(),
                        changedCount: Type.Integer({ minimum: 0 }),
