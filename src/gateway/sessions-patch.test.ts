...
const EMPTY_CFG = {} as AssistantConfig;
...
async function applySubagentModelPatch(cfg: AssistantConfig) {
...
function createAllowlistedAnthropicModelCfg(): AssistantConfig {
  return {
    agents: {
      defaults: {
