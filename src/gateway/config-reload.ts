...
export function resolveGatewayReloadSettings(cfg: AssistantConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  ...
  onHotReload: (plan: GatewayReloadPlan, nextConfig: AssistantConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: AssistantConfig) => void | Promise<void>;
  ...
  let pendingInProcessConfig: AssistantConfig | null = null;
  ...
  const queueRestart = (plan: GatewayReloadPlan, nextConfig: AssistantConfig) => {
    if (restartQueued) {
      return;
    }
    restartQueued = true;
  ...
  const applySnapshot = async (nextConfig: AssistantConfig) => {
