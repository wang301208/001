...
export const ZHUSHOU_MODEL_ID = "zhushou";
export const ZHUSHOU_DEFAULT_MODEL_ID = "zhushou/default";
...
export function resolveAgentIdFromModel(
  ...
  if (lowered === ZHUSHOU_MODEL_ID || lowered === ZHUSHOU_DEFAULT_MODEL_ID) {
