...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("zhushou.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("zhushou.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: ZhushouConfig): Promise<ContextEngine> {
