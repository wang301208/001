...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("assistant.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("assistant.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: AssistantConfig): Promise<ContextEngine> {
