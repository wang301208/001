...
describe("config discord", () => {
  it("loads discord guild map + dm group settings", () => {
    ...
    expect(cfg.dm?.groupChannels).toEqual(["assistant-dm"]);
    ...
    expect(cfg.guilds?.["123"]?.slug).toBe("friends-of-assistant");
