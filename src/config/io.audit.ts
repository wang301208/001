...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.ASSISTANT_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.ASSISTANT_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.ASSISTANT_WATCH_COMMAND),
