...
declare const assistantConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = AssistantConfig & {
  readonly [assistantConfigStateBrand]?: TState;
};
