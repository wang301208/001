...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.controlUi": "Operator Client Compatibility",
  "gateway.controlUi.enabled": "Operator Client Compatibility Enabled",
  ...
  "gateway.controlUi.basePath": "Operator Client Base Path",
  "gateway.controlUi.embedSandbox": "Operator Embed Sandbox Mode",
  "gateway.controlUi.allowExternalEmbedUrls": "Allow External Operator Embed URLs",
  "gateway.controlUi.allowedOrigins": "Operator Client Allowed Origins",
  "gateway.controlUi.dangerouslyAllowHostHeaderOriginFallback":
    "Dangerously Allow Host-Header Origin Fallback",
  "gateway.controlUi.allowInsecureAuth": "Insecure Operator Client Auth Toggle",
  "gateway.controlUi.dangerouslyDisableDeviceAuth": "Dangerously Disable Operator Client Device Auth",
  ...
  "ui.zhushou": "Zhushou Appearance",
  "ui.zhushou.name": "Zhushou Name",
  "ui.zhushou.avatar": "Zhushou Avatar",
