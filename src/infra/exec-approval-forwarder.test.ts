...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): AssistantConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): AssistantConfig {
  return {
