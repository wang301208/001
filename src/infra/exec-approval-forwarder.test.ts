...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): ZhushouConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): ZhushouConfig {
  return {
