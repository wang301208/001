...
const VITEST_FS_BASE = path.join(path.parse(process.cwd()).root, "__zhushou_vitest__");
...
function expectResolvedPackageRoot(
  syncResolver: typeof import("./zhushou-root.js").resolveZhushouPackageRootSync,
  asyncResolver: typeof import("./zhushou-root.js").resolveZhushouPackageRoot,
  opts: Parameters<typeof import("./zhushou-root.js").resolveZhushouPackageRootSync>[0],
...
vi.mock("./zhushou-root.fs.runtime.js", () => ({
  zhushouRootFsSync: mockFsModule(),
  zhushouRootFs: mockFsPromisesModule(),
}));

describe("resolveZhushouPackageRoot", () => {
  let resolveZhushouPackageRoot: typeof import("./zhushou-root.js").resolveZhushouPackageRoot;
  let resolveZhushouPackageRootSync: typeof import("./zhushou-root.js").resolveZhushouPackageRootSync;
  ...
  beforeEach(async () => {
    vi.resetModules();
    ({ resolveZhushouPackageRoot, resolveZhushouPackageRootSync } =
