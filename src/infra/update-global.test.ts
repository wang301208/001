...
describe("update global helpers", () => {
  ...
  it("prefers explicit package spec overrides", () => {
    envSnapshot = captureEnv(["ZHUSHOU_UPDATE_PACKAGE_SPEC"]);
    process.env.ZHUSHOU_UPDATE_PACKAGE_SPEC = "file:/tmp/zhushou.tgz";
    ...
    expect(
      resolveGlobalInstallSpec({
        packageName: "zhushou",
        tag: "beta",
        env: { ZHUSHOU_UPDATE_PACKAGE_SPEC: "zhushou@next" },
      }),
    ).toBe("zhushou@next");
  });
  ...
  it("maps main and explicit install specs for global installs", () => {
    ...
    expect(
      resolveGlobalInstallSpec({
        packageName: "zhushou",
        tag: "github:wang301208/zhushou#feature/my-branch",
      }),
    ).toBe("github:wang301208/zhushou#feature/my-branch");
    expect(
      resolveGlobalInstallSpec({
        packageName: "zhushou",
  ...
  it("classifies main and raw install specs separately from registry selectors", () => {
    ...
    expect(isExplicitPackageInstallSpec("github:wang301208/zhushou#main")).toBe(true);
    ...
    expect(canResolveRegistryVersionForPackageTarget("github:wang301208/zhushou#main")).toBe(false);
  });
