  ...
  it.each([
    {
      ...
      params: {
        env: { ZHUSHOU_WIDE_AREA_DOMAIN: "env.internal" } as NodeJS.ProcessEnv,
    ...
    },
    {
      ...
      params: {
        env: { ZHUSHOU_WIDE_AREA_DOMAIN: "   " } as NodeJS.ProcessEnv,
        configDomain: " ",
      },
      expected: null,
    },
...
describe("wide-area DNS-SD zone rendering", () => {
  it("renders a zone with gateway PTR/SRV/TXT records", () => {
    ...
    expectZoneRecords(txt, [
      ...
      `_zhushou-gw._tcp IN PTR studio-london._zhushou-gw._tcp`,
      `studio-london._zhushou-gw._tcp IN SRV 0 0 18789 studio-london`,
      `displayName=Mac Studio (助手)`,
      `gatewayPort=18789`,
      `sshPort=22`,
      `cliPath=/opt/homebrew/bin/zhushou`,
  ...
  it.each([
    ...
    },
    {
      ...
      records: [
        `$ORIGIN zhushou.internal.`,
        `studio-london IN A 100.123.224.76`,
        `studio-london._zhushou-gw._tcp IN TXT`,
        `displayName=Mac Studio (助手)`,
        `gatewayTls=1`,
