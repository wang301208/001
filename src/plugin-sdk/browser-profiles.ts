...
export const DEFAULT_ZHUSHOU_BROWSER_COLOR = "#FF4500";
export const DEFAULT_ZHUSHOU_BROWSER_ENABLED = true;
export const DEFAULT_ZHUSHOU_BROWSER_PROFILE_NAME = "zhushou";
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredZhushouTmpDir(), "uploads");
