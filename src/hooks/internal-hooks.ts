/**
 * Hook system for 助手 agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("assistant.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("assistant.internalHooksEnabled");
